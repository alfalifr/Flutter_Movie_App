...
class _MovieApi implements MovieApi {
  ...
  Future<MovieTrendingResponse> getTrendingList(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<MovieTrendingResponse>(
            Options(method: 'GET', headers: <String, dynamic>{}, extra: _extra)
                .compose(_dio.options, '/trending/$type/$time',
                    queryParameters: queryParameters, data: _data)
                .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = MovieTrendingResponse.fromJson(_result.data!);
    return value;
  }

  @override
  Future<MovieTrendingResponse> getTvPopular({page = 1}) async {
    const _extra = <String, dynamic>{};
  ...
  @override
  Future<MovieTrendingResponse> getMoviePopular({page = 1}) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'page': page};
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch<Map<String, dynamic>>(
